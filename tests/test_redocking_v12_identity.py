        ...
        "records": [
            {
                ...
                "result": {
                    "case_id": "RDK-001",
                    "status": "PASS",
                    "pose_1_rmsd_angstrom": 1.2345678901234,
                    "minimum_rmsd_angstrom": 1.1,
                    "pose_count": 3,
                    "vina_pose_1_score_kcal_mol": -7.2,
                    "first_loss": None,
                    "pose_1_success": True,
                },
                "provenance": {
                    ...
                    "extraction": {
                        "ligand_auth_seq_id": 300,
                        "ligand_insertion_code": "",
                        "ligand_heavy_atoms_from_pdb": 16,
                        "receptor_atom_count": 1000,
                        "receptor_sha256": "b" * 64,
                        "native_ligand_pdb_sha256": "c" * 64,
                    },
                    ...
                    "engines": {
                        "openbabel": {"path": "/usr/bin/obabel", "version": "Open Babel 3.1.1"},
                        "vina": {"path": "/tmp/vina", "version": "AutoDock Vina v1.2.7"},
                    },
                    "preparation": {
                ...
                "poses": [{"rank": 1, "score_kcal_mol": -7.2, "status": "PASS", "rmsd_angstrom": 1.2345678901234, "pdbqt_sha256": "5" * 64, "sdf_sha256": "6" * 64}],
            }
        ],
        "summary": {
            "protocol_id": "research-os.redocking.v1.2",
            "total_cases": 1,
            "passing_rmsd_cases": 1,
            "status_counts": {"PASS": 1},
            "pose_1_rmsd_angstrom": {"mean_over_passing_cases": 1.2345678901234, "median_over_passing_cases": 1.2345678901234, "values": [1.2345678901234]},
            "pose_1_rmsd_le_2_angstrom": {"count": 1, "fraction_all_frozen_cases": 1.0, "denominator": 1},
            "cases": [],
            "summary_hash": "7" * 64,
        },
