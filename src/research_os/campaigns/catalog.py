...
REAL_PROBLEM_CATALOG: tuple[ProblemCandidate, ...] = (
    ...
    _p("P-BATT-01", "Battery degradation trajectory reproducibility from public records", "battery/electrochemistry", "Battery life datasets are heterogeneous in protocol, cell identity and environmental conditions.", "Can a public battery record be normalized into a condition-complete degradation experiment without inventing missing fields?", "Life prediction is only actionable when cycle, temperature, current and cell metadata are traceable.", ("SRC-DOE-BATTERY-DATA-HUB", "SRC-NASEM-REPRO"), ("DOE Battery Data Hub records; access to be reviewed"), ("dataset schema audit", "uncertainty and missingness"), ("none configured",), EvidenceLevel.E4_CURATED_EXPERIMENTAL, ("no downloaded public battery record in this repository", "access/licensing review"), ("no battery control or safety recommendation",)),
