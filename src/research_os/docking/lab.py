...
class DockingLab(Lab):
    ...
    def run(self, raw: dict[str, Any], experiment: str = "vina_docking") -> RunManifest:
        ...
        engine_manifest = EngineManifest(
            ...
            library_version=result.engine_version, configuration={"grid": n["grid"], "target_id": n.get("target_id"), "seed": n["seed"], "exhaustiveness": n["exhaustiveness"], "cpu": n["cpu"]},
