...
from research_os.labs.domain import DOMAIN_LABS


def default_registry():
    r=LabRegistry(); r.register(MoleculeLab(),aliases=("molecule","molecular")); r.register(FuelLab(),aliases=("fuel","fuels")); r.register(CombustionLab(),aliases=("combustion",)); r.register(DockingLab(),aliases=("docking",)); r.register(PharmaLab(),aliases=("pharma","biolab")); r.register(PropulsionLab(),aliases=("propulsion",)); r.register(MetalLab(),aliases=("metal","metallurgy")); r.register(KnowledgeLab(),aliases=("knowledge","zettelkasten")); r.register(ThermalLab(),aliases=("thermal","heat")); r.register(DegradationLab(),aliases=("degradation","corrosion"));
    for lab_class in DOMAIN_LABS:
        r.register(lab_class())
    return r
